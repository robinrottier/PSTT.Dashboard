...
#### `src/MqttDashboard.Server/Extensions/WebApplicationBuilderExtensions.cs` — new startup extension methods
...
#### `src/MqttDashboard.WebApp/MqttDashboard.WebApp/Program.cs` — reduced from ~100 → ~35 lines
...
#### `src/MqttDashboard.WebApp/MqttDashboard.WebAppServerOnly/Program.cs` — reduced from ~95 → ~20 lines
...
#### `src/MqttDashboard.WebApp/MqttDashboard.WebApp/Dockerfile` — dual port exposure
